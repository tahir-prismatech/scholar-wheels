...
export default function AddAndEditDriver() {
    return (
        <>
            <Header title="Add New Driver" description={"Driver Management   >  Add New Driver"} />
            <Height height={"20px"} />
            <div className="d-flex flex-column gap-3 border-class">
                    ...
                    <VehicleForm
                        fields={
                            [
                                ...
                                { type: 'select', label: 'License Category', options: ['cat 1', 'cat 2', 'cat 3'] },
                ...
                <div className="d-flex align-items-center gap-3">
                    <VehicleForm
                        fields={
                            [
                                { type: 'text', label: 'License Number', placeholder: 'Enter license number' },
                                { type: 'date', label: 'License Expiry Date', options: ['Car', 'Bus'] },
                            ]
                        }
                    />
                </div>
